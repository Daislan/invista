...
<head>
    ...
    <title>Invista nas Cidades</title>
    ...
    <link href="css/app.css" id="theme" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <?php
                    $stmt = $con->prepare('SELECT * FROM oportunidades WHERE id_oportunidade = ?');
                    $stmt->bindValue(1, $id);
                    $stmt->execute();

                    
                    <div class="overlay-bg" style="background-image: linear-gradient(rgba(0, 0, 0, .35),rgba(0, 0, 0, .55)), url(img/demo.jpg);"> 
                        <h3></h3>
                    </div>
                ?>
            </div>
            ...
            <div class="container-fluid description">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="white-box">
                                <h2>Título da Oportunidade</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sit amet diam lacus. Vivamus suscipit ultricies arcu, nec varius ante vehicula eget. Morbi vitae odio non diam vehicula congue sed ac risus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sit amet diam lacus. Vivamus suscipit ultricies arcu, nec varius ante vehicula eget. Morbi vitae odio non diam vehicula congue sed ac risus.</p>
                                
                                <h3>Descrição completa</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur sit amet diam lacus. Vivamus suscipit ultricies arcu, nec varius ante vehicula eget. Morbi vitae odio non diam vehicula congue sed ac risus. </p>
                        ...
                        <div class="col-md-4">
                            <div class="menu-right">
                                ...
                                <hr>
                                <ul class="incentivos">
                                    <li><span>1</span> Possibilidade de terreno</li>
                                    <li><span>2</span> Incentivos fiscais</li>
                                    <li><span>3</span> Networking com indústrias</li>
                                    <li><span>4</span> Auxílio Jurídico</li>
                                    <li><span>5</span> Networking com investidores</li>
                                </ul>
                            </div>
                            
                            <div class="contact">
                                <div class="white-box">
                                    <button class="btn btn-warning btn-lg btn-full">Registre seu interesse</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                                <label for="">Escolha um Estado</label>
